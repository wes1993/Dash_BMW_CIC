...
DebugWindow::DebugWindow(Arbiter &arbiter, QWidget *parent) : QWidget(parent)
{
    ...
    QLabel* inReverse = new QLabel("--", this);
    QLabel* rotaryPrevPos = new QLabel("--", this);
    QLabel* rotaryPos = new QLabel("--", this);
    QLabel* msgCounter = new QLabel("--", this);
    QLabel* lastKey = new QLabel("--", this);
